...
const SuspendProfile = () => {
  ...
  return (
    <div className={` max-h-[58vh] h-[58vh] overflow-y-auto w-full px-6 py-4 flex justify-center items-center flex-col text-white gap-y-6 sm:gap-y-2 border-2 border-white/30  rounded-lg`}>
      ...
      <form id="suspendProfileForm" className="w-full flex flex-col items-center justify-center sm:flex-row sm:justify-around mt-8">
        <button type='submit'           
