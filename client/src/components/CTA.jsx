        ...
        <div className="container mx-auto bg-[#27283A] relative max-w-[1170px] min-h-[240px] rounded-[24px] flex flex-row justify-center items-center" >
            ...
            <div className="flex flex-wrap gap-2 sm:flex-nowrap mx-auto items-center justify-center py-2.5 sm:px-24 z-[1]">
                ...
                <div className="flex items-center justify-start shadow-xl">
                    <input type="email" className="w-auto h-[64px] bg-[#3E3E54] text-secondary outline-none rounded-[14px] py-1 px-6 " placeholder="Ingresa tu email..."/>
                    <button type='button'           
                    ...
                    <button type='button'           
                            className={`sm:hidden w-[auto h-[64px] py-1 px-4 bg-gray-gradient gap-2 flex flex-row items-center justify-between font-monse font-normal text-[16px] text-white hover:text-secondary outline-none rounded-[14px] ml-[-60px]`}> 
                        Suscribir <img src={icon} alt='Icon' />
                    </button>
                </div>  
            </div>
